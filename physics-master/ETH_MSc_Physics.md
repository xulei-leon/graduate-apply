...
- **GRE requirement:** Not required (check specific requirements)
- **TOEFL/IELTS:** English C1 proficiency required
- **Prerequisites:** BSc in Physics or equivalent (min 180 ECTS)
- **Cohort size:** ~80–100
- **Deadline:** November (international window for Autumn start)
- **Funding:** Low tuition (CHF ~1,500/semester); ESOP scholarship available (very competitive)
